 ...
 * 3. Jalankan: node scripts/setupDatabase.mjs
 *
 * PENTING: Pastikan sudah update Firestore Rules sebelum menjalankan script ini!
 */
...
async function main() {
  try {
    ...
    console.error("   • Firestore Rules tidak memperbolehkan write\n");
